...
(
    ...
    output wire dout_data,
    output wire is_done,
    output wire one_group_done
);
    ...
    wire xor_0_0_q, xor_0_1_q, xor_0_2_q, xor_0_3_q, xor_0_4_q, xor_0_5_q, xor_0_6_q, xor_0_7_q;
    wire xor_1_0, xor_1_1, xor_1_2, xor_1_3;
    wire xor_1_0_q, xor_1_1_q, xor_1_2_q, xor_1_3_q;
    wire xor_2_0, xor_2_1;
    wire xor_3_0;
    wire din_vld_q, din_vld_q_q, din_vld_q_q_q;
    reg [1:0] state; // 2'b00: IDLE, 2'b01: CALC, 2'b10: WAIT, 2'b11: DONE
    wire start_calc;
    ...
    always @(posedge clk or negedge rst_n) begin
        ...
        else if (dout_vld && (state == CALC) && cnt_reg != FULL_DATA_WIDTH-1) begin
            GenM_reg <= {GenM_reg[0], GenM_reg[FULL_DATA_WIDTH-1:1]};
        end
        else begin
            GenM_reg <= GenM_reg;
        end
    ...
    assign is_done = (state == WAIT);
    assign one_group_done = (state == DONE);
