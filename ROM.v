...
(
    ...
    reg [FULL_DATA_WIDTH - 1:0] Rom_reg0 [GENM_ROW - 1:0];
    reg [FULL_DATA_WIDTH - 1:0] Rom_reg1 [GENM_ROW - 1:0];
    reg [FULL_DATA_WIDTH - 1:0] Rom_reg2 [GENM_ROW - 1:0];
    reg [FULL_DATA_WIDTH - 1:0] Rom_reg3 [GENM_ROW - 1:0];
    reg [$clog2(GENM_ROW)-1:0] addr0;
    reg [$clog2(GENM_ROW)-1:0] addr1;
    reg [$clog2(GENM_ROW)-1:0] addr2;
    reg [$clog2(GENM_ROW)-1:0] addr3;
